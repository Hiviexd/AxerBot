...
import { RulesetBeatmap, ScoreInfo } from "osu-classes";
...
function calculateScore(osu_file: string, rulesetId: number, score: Score) {
	...
	const difficulty = scoreInfo.totalHits !== beatmapInfo.totalHits
	...
	const fcDifficulty = scoreInfo.totalHits !== beatmapInfo.totalHits
		? difficultyCalculator.calculateWithMods(combination)
		: difficulty;
...
function simulateFC(beatmap: RulesetBeatmap, scoreInfo: ScoreInfo): ScoreInfo {
